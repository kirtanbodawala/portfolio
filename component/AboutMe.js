      ...
      <Row className="justify-content-center">
        <Col xs={12}>
          <p className={`${aboutStyles.aboutMeTxt}`}>
            ...
            engineer with 4+ years of experience in architecting, designing and
        ...
        <Row className="">
          ...
          <Col xs={6} md={4} lg={2}>
            <Figure>
              ...
              />
              <Figure.Caption className="text-center">WORDPRESS</Figure.Caption>
            </Figure>
          </Col>
          <Col xs={6} md={4} lg={2}>
            <Figure>
        ...
        <Row className="justify-content-center">
          ...
          <Col xs={6} md={4} lg={2}>
            <Figure>
              ...
              />
              <Figure.Caption className="text-center">BOOTSTRAP</Figure.Caption>
            </Figure>
          </Col>
          <Col xs={6} md={4} lg={2}>
            <Figure>
