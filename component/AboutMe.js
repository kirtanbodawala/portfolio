            ...
            <section className={`${myStyles.wrapper}`}>
                <Container fluid="md">
                    <Row className="justify-content-md-center">
                        <Col xs={12}>
                            <p
                                className={`${aboutStyles.aboutMeTxt}`}
                            >
                                I am innovative optimized solution seeker and a full stack software engineer with 4+ years of experience in architecting, designing and implementing new products, technical solutions and feature improvements for different projects by using PHP, Wordpress and NextJS.
                            </p>
                        </Col>
                        <Col xs={12}>
                            <p
                                className={`${aboutStyles.aboutMeTxt}`}
                            >
                                Capable of strong leadership and good organization to make sure every project is done on time.
                            </p>
                        </Col>
                    </Row>
                    ...
                    <div className={`${aboutStyles.prog} mt-5`}>
                        <hr className={`${aboutStyles.hrText}`} data-content="DEVELOPMENT TOOLS" />
                        <Row className="justify-content-md-center">
                            <Col xs={6} lg={2}>
                                <Figure>
                                    <Figure.Image
                    ...
                    <div className={`${aboutStyles.prog} mt-5`}>
                        <hr className={`${aboutStyles.hrText}`} data-content="OPERATING SYSTEMS" />
                        <Row className="justify-content-md-center">
                            <Col xs={6} lg={2}>
                                <Figure>
                                    <Figure.Image
